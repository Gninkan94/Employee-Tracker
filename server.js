...
// this is to create a MySQL connection
const connection = mysql.createConnection({
    host: "localhost",
    port: 3306,
    user: "root",
    password: "Gninkan2394",
...
// this function is to Start the Diallo's SQL Employee Tracker Application
function start() {
    inquirer
        .prompt({
            type: "list",
...
// this is function to view all departments
...
// this is a function to view all roles
...
// this is a function to view all employees
...
// this is a function to add a department
            ...
            .then((answers) => {
                ...
                connection.query(
                    ...
                    (err, res) => {
                        ...
                        // this is restart the application
                        start();
                    }
                );
            });
...
function addEmployee() {
    // And will etrieve list of roles from the database
    connection.query("SELECT id, title FROM roles", (error, results) => {
        ...
        //this will  retrieve  the list of employees from the database 
        connection.query(
            ...
            (error, results) => {
                ...
                // this is to prompt the user for employee information
                inquirer
                    .prompt([
                        {
                            type: "input",
                    ...
                    .then((answers) => {
                        //this is to  Insert the employee into the database
                        const sql =
...
// this function is to add a Manager
function addManager() {
...
// this function is to update employee role
...
// this function to View Employee By Manager
function viewEmployeesByManager() {
    ...
    connection.query(query, (err, res) => {
        ...
        // this is the group of employees by manager
        ...
        // this is torestart the application
        start();
    });
}
//this  function is to view Employees by Department
...
// this function is to dlete Departments Roles Employees
...
// this function is to delete Employees
function deleteEmployee() {
    ...
    connection.query(query, (err, res) => {
        ...
        inquirer
            ...
            .then((answer) => {
                if (answer.id === "back") {
                    // this will check if user selected go back
                    deleteDepartmentsRolesEmployees();
                    return;
                }
                ...
                connection.query(query, [answer.id], (err, res) => {
                    ...
                    //  thi is to restart the application
                    start();
                });
            });
    });
...
function deleteRole() {
    //this  retrieve all available roles from the database
    const query = "SELECT * FROM roles";
    connection.query(query, (err, res) => {
        if (err) throw err;
        // this map through the retrieved roles to create an array of choices
        const choices = res.map((role) => ({
            name: `${role.title} (${role.id}) - ${role.salary}`,
            value: role.id,
        }));
        // this will add a Go Back option for user to choose from the list of choices
        ...
        inquirer
            ...
            .then((answer) => {
                ...
                if (answer.roleId === null) {
                    // lets go back to the delete Departments Roles Employees !!
                    deleteDepartmentsRolesEmployees();
                    return;
                }
...
//  this fuction is to DELETE department
function deleteDepartment() {
    //lets  get the list of departments!!
    const query = "SELECT * FROM departments";
    connection.query(query, (err, res) => {
        if (err) throw err;
        ...
        inquirer
            ...
            .then((answer) => {
                if (answer.departmentId === "back") {
                    // this will  go back to the previous menu
                    deleteDepartmentsRolesEmployees();
                } else {
...
//  this function is to view the total used Budget of Department
function viewTotalUtilizedBudgetOfDepartment() {
    ...
    connection.query(query, (err, res) => {
        ...
        //  this fuction will prompt to the user to select a department
        inquirer
            .prompt({
                type: "list",
                name: "departmentId",
            ...
            .then((answer) => {
                // this would calculate the salary for the selected department
                const query =
                    `SELECT 
                ...
                connection.query(query, [answer.departmentId], (err, res) => {
                    ...
                    console.log(
                        `The employees salary in this department is $${totalSalary}`
                    );
...
// This function will close the connection after the application exits
process.on("exit", () => {
    connection.end();
});
